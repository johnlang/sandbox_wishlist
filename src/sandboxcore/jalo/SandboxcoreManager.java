...
import sandboxcore.constants.SandboxcoreConstants;



/**
 * This is the extension manager of the Sandboxcore extension.
 */
public class SandboxcoreManager extends GeneratedSandboxcoreManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(SandboxcoreManager.class.getName());
	 ...
	 */
	public static SandboxcoreManager getInstance()
	{
		return (SandboxcoreManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				SandboxcoreConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SandboxcoreManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SandboxcoreManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of SandboxcoreManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of SandboxcoreManager called, current tenant: " + getTenant().getTenantID());
		}
	}
